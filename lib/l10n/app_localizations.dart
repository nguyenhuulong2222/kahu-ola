...
abstract class AppLocalizations {
  ...
  /// No description provided for @survival_checklist.
  ///
  /// In en, this message translates to:
  /// **'Survival Checklist'**
  String get survival_checklist;
...
class _AppLocalizationsDelegate extends LocalizationsDelegate<AppLocalizations> {
  ...
  @override
  bool isSupported(Locale locale) => <String>['en', 'haw', 'vi'].contains(locale.languageCode);
